...
Scene.start = function () {
	...
	// Wait till the bot image is loaded before starting the animation.
...
Scene.clearCanvas = function () {
    ...
    Scene.canvasContext.fillRect(0, 0, Scene.canvas.width, 152);
};
...
Scene.mainLoop = function() {
    ...
    window.setTimeout(Scene.mainLoop, 1000 /12);
};
